...
require_once("../Controladores/cntrlHumeTierra.php");
include "../Vistas/portada.php";
?>

<div  class = "container">       
    <div class="col-md-8 col-md-offset-2 ">
        <form class="condicion" action="../Controladores/cntrlHumeTierra.php" method="post">
            <div class="titulo">
                <label><h4>Humedad tierra </h4></label>
            </div>
            <div class="datos">
